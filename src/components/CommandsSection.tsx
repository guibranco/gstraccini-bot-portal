...
const commands = [
  ...
  },
  {
    ...
    description:
      "Updates the .csproj file with the packages.config version of NuGet packages (only for .NET Framework projects).",
  ...
  },
  {
    ...
    description:
      "Updates dependencies in a package.json and package-lock.json.",
