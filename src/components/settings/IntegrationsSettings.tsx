...
export function IntegrationsSettings({
  ...
  return (
    <SettingsCard title="Integration Settings" icon={icon}>
        ...
        {hasIntegration("SonarCloud") && (
          <div className="space-y-6">
            ...
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("sonarcloud", "autoAnalyze", checked)
              }
            />
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("sonarcloud", "qualityGate", checked)
              }
            />
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("sonarcloud", "blockMerge", checked)
              }
            />
          </div>
        )}
        ...
        {hasIntegration("Codecov") && (
          <div className="space-y-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("codecov", "autoAnalyze", checked)
              }
            />
        ...
        {hasIntegration("Snyk") && (
          <div className="space-y-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("snyk", "blockHighVulnerabilities", checked)
              }
            />
            <SettingToggle
              id="snyk_block_merge"
        ...
        {hasIntegration("OpenAI") && (
          <div className="space-y-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("openai", "suggestFixes", checked)
              }
            />
            <SettingToggle
              ...
              onChange={(checked) =>
                onChange("openai", "improveDescription", checked)
              }
            />
          </div>
        )}
