...
export function Header({ user }: HeaderProps) {
  ...
  useEffect(() => {
    ...
    const shouldUseDarkMode = storedPreference === 'true' || (storedPreference === null && darkModePreference);
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            <Link to="/dashboard" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">GStraccini Bot</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center space-x-4">
              <Link 
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-gray-700 transition-colors ${
                  location.pathname === '/dashboard' ? 'bg-blue-700 dark:bg-gray-700' : ''
                }`}
              >
              ...
              <Link 
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-gray-700 transition-colors ${
                  location.pathname === '/dashboard/repositories' ? 'bg-blue-700 dark:bg-gray-700' : ''
                }`}
              >
              ...
              <Link 
                to="/dashboard/issues"
                className={`flex items-center space-x-2 px-3 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-gray-700 transition-colors ${
                  location.pathname === '/dashboard/issues' ? 'bg-blue-700 dark:bg-gray-700' : ''
                }`}
              >
              ...
              <Link 
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md hover:bg-blue-700 dark:hover:bg-gray-700 transition-colors ${
                  location.pathname === '/dashboard/pull-requests' ? 'bg-blue-700 dark:bg-gray-700' : ''
                }`}
              >
            ...
            <div className="relative" ref={notificationsRef}>
              ...
              {isNotificationsOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-1 text-gray-800 dark:text-gray-200 z-50">
                  <div className="px-4 py-2 font-semibold border-b border-gray-200 dark:border-gray-700">Notifications</div>
            ...
            <div className="relative" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-1 text-gray-800 dark:text-gray-200 z-50">
                  <Link to="/" className="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <Link to="/dashboard/account" className="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                    <User className="w-4 h-4 mr-2" />
                    Account
                  </Link>
                  <Link to="/dashboard/settings" className="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                    <Settings className="w-4 h-4 mr-2" />
                    Settings
                  </Link>
                  <Link to="/dashboard/integrations" className="flex items-center px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
