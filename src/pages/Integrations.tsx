...
export function Integrations() {
  ...
  const handleAddIntegration = async () => {
    if (!selectedProvider || apiKey.length < 10) {
      setError('Please select a provider and enter a valid API key (minimum 10 characters)');
      return;
    }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center space-x-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">Manage your external service integrations</p>
        </div>
      </div>
