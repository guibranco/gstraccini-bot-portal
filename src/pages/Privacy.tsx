          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                GStraccini Bot ("we," "our," or "us") is committed to protecting
                your privacy. This Privacy Policy explains how we collect, use,
                disclose, and safeguard your information when you use our GitHub
                application and related services.
              </p>
              <p className="text-gray-600 mb-4">
                By using GStraccini Bot, you agree to the collection and use of
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                When you use GStraccini Bot, we collect information that helps
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-4">
                ...
                <li>
                  Repository access permissions you grant to our application
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-4">
                ...
                <li>
                  Commit messages and file changes (when processing commands)
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>
                  Send important notifications about service changes or updates
                </li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                assist in our operations, including:
              </p>
              <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                <li>
                  Account information: Until you delete your account or revoke
                  access
                </li>
                ...
                <li>
                  Analytics data: Aggregated and anonymized data may be retained
                  indefinitely
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                GStraccini Bot integrates with various third-party services to
              ...
              <p className="text-gray-600 mt-4">
                These integrations are subject to their respective privacy
            ...
            <section>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700 mb-2">
                  <strong>Email:</strong>{" "}
                  <a
                    href="mailto:privacy@gstraccini-bot.com"
