...
const incidents = [
  {
    ...
    severity: "major",
    description:
      "We are investigating increased latency in webhook delivery systems affecting automated responses to GitHub events.",
    updates: [
      {
        time: "14:45 UTC",
        message:
          "Engineering team has identified the root cause and is implementing a fix.",
      },
      {
        time: "14:23 UTC",
        message:
          "We have detected increased webhook processing times and are investigating.",
      },
    ],
  },
  {
    ...
    severity: "minor",
    description:
      "Database performance is degraded due to increased load. Our team is working on scaling the infrastructure.",
    updates: [
      {
        time: "13:30 UTC",
        message:
          "Additional database replicas have been deployed to handle the increased load.",
      },
      {
        time: "12:15 UTC",
        message:
          "Monitoring systems detected elevated database response times.",
      },
    ],
  },
  {
    ...
    severity: "minor",
    description:
      "The rate limiting issues have been resolved by updating our configuration.",
    updates: [
      {
        time: "23:15 UTC",
        message:
          "All systems are now operating normally. Rate limiting has been restored to expected levels.",
      },
      {
        time: "22:45 UTC",
        message:
          "We identified an issue with our rate limiting configuration causing some requests to be incorrectly throttled.",
      },
    ],
  },
];
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Real-time status of GStraccini Bot services
              </p>
            </div>
          </div>
            ...
            <div className="flex items-center gap-4">
              <div className={`p-2 rounded-full bg-white`}>
                {overallStatus.status === "operational" && (
                  <CheckCircle2
                    className={`h-8 w-8 ${overallStatus.iconColor}`}
                  />
                )}
                ...
                {overallStatus.status === "incident" && (
                  <XCircle className={`h-8 w-8 ${overallStatus.iconColor}`} />
                )}
              </div>
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Last updated: March 1, 2025 15:00 UTC
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  <p>
                    This page is updated in real-time and shows the current
                    status of all GStraccini Bot services.
                  </p>
                  <p>
                    Status updates are posted automatically when incidents are
                    detected or resolved.
                  </p>
                  <p>
                    For historical data and detailed metrics, visit our
