...
import { FileText, ArrowLeft, Scale, Users, Shield, AlertTriangle, Clock, Globe } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Legal terms and conditions for using GStraccini Bot</p>
            </div>
          </div>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <p className="text-gray-700 mb-4">
                  By accessing or using GStraccini Bot ("the Service"), you agree to be bound by these Terms of Service ("Terms") and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this service.
                </p>
                <p className="text-gray-700">
                  These Terms constitute a legally binding agreement between you and GStraccini Bot. Your use of the Service is also governed by our Privacy Policy, which is incorporated by reference into these Terms.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                <p className="text-gray-700 mb-4">
                  GStraccini Bot is a GitHub application that provides automated workflow management, code quality analysis, and repository maintenance services. The Service includes:
                </p>
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">3. Use License and Restrictions</h2>
              </div>
              <div className="bg-purple-50 rounded-lg p-6 border border-purple-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">3.1 License Grant</h3>
                <p className="text-gray-700 mb-4">
                  Subject to these Terms, we grant you a limited, non-exclusive, non-transferable, revocable license to use the Service for your legitimate business or personal purposes.
                </p>
                
                <h3 className="text-lg font-semibold text-gray-800 mb-3">3.2 Restrictions</h3>
                <p className="text-gray-700 mb-4">
                  You may not:
                </p>
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">4. Service Availability and Modifications</h2>
              </div>
              <div className="bg-orange-50 rounded-lg p-6 border border-orange-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">4.1 Service Availability</h3>
                <p className="text-gray-700 mb-4">
                  We strive to provide uninterrupted service, but we do not guarantee that the Service will be available at all times. The Service may be temporarily unavailable due to:
                </p>
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-3">4.2 Service Modifications</h3>
                <p className="text-gray-700">
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">5. User Responsibilities and Conduct</h2>
              </div>
              <div className="bg-indigo-50 rounded-lg p-6 border border-indigo-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">5.1 Account Security</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-3">5.2 Acceptable Use</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-3">5.3 Prohibited Activities</h3>
                <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="bg-teal-50 rounded-lg p-6 border border-teal-200">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  ...
                  <li>The retention of your data for the periods specified in our Privacy Policy</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">7. Third-Party Integrations</h2>
              </div>
              <div className="bg-cyan-50 rounded-lg p-6 border border-cyan-200">
                ...
                <p className="text-gray-700">
                  Your use of these third-party services is subject to their respective terms of service and privacy policies. We are not responsible for the availability, content, or practices of these third-party services.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">8. Disclaimers and Limitation of Liability</h2>
              </div>
              <div className="bg-red-50 rounded-lg p-6 border border-red-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">8.1 Service Disclaimers</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-3">8.2 Limitation of Liability</h3>
                <p className="text-gray-700 mb-4">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  ...
                  <li>Damages exceeding the amount paid by you for the Service in the 12 months preceding the claim</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-emerald-50 rounded-lg p-6 border border-emerald-200">
                <p className="text-gray-700 mb-4">
                  You agree to indemnify, defend, and hold harmless GStraccini Bot, its officers, directors, employees, agents, and affiliates from and against any claims, liabilities, damages, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising from:
                </p>
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              ...
              <div className="bg-violet-50 rounded-lg p-6 border border-violet-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">10.1 Termination by You</h3>
                <p className="text-gray-700 mb-4">
                  You may terminate your use of the Service at any time by uninstalling the GitHub application and ceasing to use our services.
                </p>

                <h3 className="text-lg font-semibold text-gray-800 mb-3">10.2 Termination by Us</h3>
                <p className="text-gray-700 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-3">10.3 Effect of Termination</h3>
                <p className="text-gray-700">
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">11. Governing Law and Dispute Resolution</h2>
              </div>
              <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">11.1 Governing Law</h3>
                <p className="text-gray-700 mb-4">
                  These Terms shall be governed by and construed in accordance with the laws of [Jurisdiction], without regard to its conflict of law provisions.
                </p>

                <h3 className="text-lg font-semibold text-gray-800 mb-3">11.2 Dispute Resolution</h3>
                <p className="text-gray-700 mb-4">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  ...
                  <li>The exclusive jurisdiction of courts in [Jurisdiction] for any matters not subject to arbitration</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-gray-900">12. General Provisions</h2>
              </div>
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">12.1 Entire Agreement</h3>
                <p className="text-gray-700 mb-4">
                  These Terms, together with our Privacy Policy, constitute the entire agreement between you and us regarding the Service.
                </p>

                <h3 className="text-lg font-semibold text-gray-800 mb-3">12.2 Severability</h3>
                <p className="text-gray-700 mb-4">
                  If any provision of these Terms is found to be unenforceable, the remaining provisions will remain in full force and effect.
                </p>

                <h3 className="text-lg font-semibold text-gray-800 mb-3">12.3 Waiver</h3>
                <p className="text-gray-700 mb-4">
                  No waiver of any term or condition shall be deemed a further or continuing waiver of such term or any other term.
                </p>

                <h3 className="text-lg font-semibold text-gray-800 mb-3">12.4 Assignment</h3>
                <p className="text-gray-700">
                ...
                <div className="grid gap-4">
                  <div>
                    <p className="text-gray-700 mb-2">
                      ...
                      <a href="mailto:legal@gstraccini-bot.com" className="text-blue-600 hover:text-blue-800 transition-colors">
                  ...
                  <div>
                    <p className="text-gray-700 mb-2">
                      ...
                      <a href="mailto:support@gstraccini-bot.com" className="text-blue-600 hover:text-blue-800 transition-colors">
