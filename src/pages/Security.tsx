        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          ...
          <div className="prose max-w-none">
            <p className="text-gray-600 mb-8">
              Security is at the core of everything we do. GStraccini Bot is
              designed with multiple layers of protection to ensure your code,
              data, and repositories remain secure.
            </p>
            ...
            <div className="grid gap-8">
                  ...
                  <div className="grid gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          All data is encrypted using AES-256 encryption when
                          stored in our databases and file systems.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          All data transmission is protected using TLS 1.3 with
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          We conduct quarterly security audits and annual
                          penetration testing by certified security
                          professionals.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          We process your code without storing sensitive content
                  ...
                  <div className="grid gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Secure authentication through GitHub's OAuth 2.0 with
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Support for FIDO2 WebAuthn, TOTP authenticators, and
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Fine-grained access control with repository-level
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Secure session handling with automatic expiration and
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Private networks, VPCs, and firewall rules to isolate
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Containerized applications with security scanning and
                          runtime protection.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="grid gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Automated security scanning of our codebase using
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Security-first development practices with mandatory
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Secure storage and rotation of API keys, tokens, and
                  ...
                  <div className="grid gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Full compliance with European data protection
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Comprehensive audit trails for all data access and
              ...
              <section>
                ...
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg p-6 border border-orange-200">
                  <p className="text-gray-600 mb-6">
                    ...
                    the security community's efforts to help us maintain the
                  ...
                  <div className="grid gap-4 mb-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Please report vulnerabilities privately to allow us
                          time to fix them before public disclosure.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          We aim to acknowledge reports within 24 hours and
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          We maintain a security hall of fame to recognize
                          researchers who help improve our security.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <section>
                ...
                <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg p-6 border border-emerald-200">
                  <p className="text-gray-600 mb-4">
                    Our dedicated security team consists of experienced
                    professionals who continuously monitor, assess, and improve
                  ...
                  <div className="grid gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Round-the-clock security monitoring and incident
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Active participation in security communities and
              ...
              <section>
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg p-6 border border-yellow-200">
                  <p className="text-gray-600 mb-4">
                    We have a comprehensive incident response plan to quickly
                    address and resolve security incidents.
                  </p>
                  <div className="grid gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Immediate containment and mitigation procedures for
                          security incidents.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Transparent communication with affected users and
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Thorough analysis and improvement of security measures
                          after each incident.
                        </p>
                      </div>
                    </div>
              ...
              <section className="border-t pt-8">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  urgent security matters, please contact our security team:
                </p>
                  ...
                  <div className="grid gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        For urgent security matters, please include "URGENT" in
                        the subject line.
                      </p>
                    </div>
                    <div>
